...
| 날짜  | 문제                                  | 링크                                                                                       | 유형          |
| ----- | ------------------------------------- | ------------------------------------------------------------------------------------------ | ------------- |
| 10_10 | CT\_컨베이어벨트                      | [컨베이어벨트](코드트리/Simulation/컨베이어벨트/컨베이어벨.java)                           | simulataion   |
| 10_10 | CT\_삼각형컨베이어벨트                | [삼각형컨베이어벨트](코드트리/Simulation/삼각형컨베이어벨트/삼각형컨베이어벨트.java)       | simulataion   |
| 10_11 | CT_1차원바람                          | [1차원바람](코드트리/Simulation/1차원바람/1차원바람.java)                                  | simulataion   |
| 10_11 | CT_1차원젠가                          | [1차원젠가](코드트리/Simulation/1차원젠가/1차원젠가.java)                                  | simulataion   |
| 10_11 | CT\_십자모양폭발                      | [십자모양폭발](코드트리/Simulation/십자모양폭발/십자모양폭발.java)                         | simulataion   |
| 10_11 | CT_1차원폭발게임                      | [1차원폭발게임](코드트리/Simulation/1차원폭발게임/1차원폭발게임.java)                      | simulataion   |
| 10_11 | CT\_숫자가더큰인접한곳으로이동        | [숫자가더큰인접한곳으로이동](코드트리/Simulation/숫자가더큰인접한곳으로이동/숫자더큰.java) | simulataion   |
| 10_11 | CT\_떨어지는1자블록                   | [떨어지는1자블록](코드트리/Simulation/떨어지는1자블록/떨어지는1자블록.java)                | simulataion   |
| 10_12 | CT_k중하나n번선택하기                 | [k중하나n번선택하기](코드트리/BackTracking/k중하나를n번선택하기/k중하나.java)              | 백트래킹      |
| 10_12 | CT\_아름다운수                        | [아름다운수](코드트리/BackTracking/아름다운수/아름다운수.java)                             | 백트래킹      |
| 10_12 | CT\_강렬한폭발                        | [강렬한폭발](코드트리/BackTracking/강렬한폭발/강렬한폭발.java)                             | 백트래킹      |
| 10_13 | CT\_특정조건에맞게k게중에1개를n번뽑기 | [특정조건](코드트리/BackTracking/특정조건k중n번/특정조건.java)                             | 백트래킹      |
| 10_13 | CT_1차원윷놀이                        | [1차원윷놀이](코드트리/BackTracking/1차원윷놀이/1차원윷놀이.java)                          | 백트래킹      |
| 10_13 | CT\_방향에맞춰최대로움직이기          | [방향에맞춰](코드트리/BackTracking/방향에맞춰최대로움직이기/방향.java)                     | 백트래킹      |
| 10_13 | CT\_그래프탐색                        | [그래프탐색](코드트리/Dfs/그래프탐색/그래프탐색.java)                                      | dfs           |
| 10_13 | CT\_두방향탈출가능여부판별            | [두방향탈출](코드트리/Dfs/두방향탈출가능/두방향탈출.java)                                  | dsf           |
| 10_13 | CT\_마을구분하기                      | [마을구분하기](코드트리/Dfs/마을구분하기/마을구분하기.java)                                | dsf           |
| 10_14 | CT\_그래프탐색                        | [그래프탐색](코드트리/Dfs/그래프탐색/그래프탐색.java)                                      | hashmap       |
| 10_14 | CT\_두방향탈출가능여부판별            | [두방향탈출](코드트리/Dfs/두방향탈출가능/두방향탈출.java)                                  | hashmap       |
| 10_14 | CT\_마을구분하기                      | [마을구분하기](코드트리/Dfs/마을구분하기/마을구분하기.java)                                | hashmap       |
| 10_17 | PG_lv3\_이중우선순위큐                | [이중우선순위큐](프로그래머스/3/42628. 이중우선순위큐/이중우선순위큐.java)                 | heap          |
| 10_17 | PG_lv3\_야근지수                      | [야근지수](프로그래머스/3/12927. 야근 지수/야근지수.java)                                  | heap, math    |
| 10_17 | PG_lv3\_최고의집합                    | [이중우선순위큐](프로그래머스/3/12938. 최고의 집합/최고의집합.java)                        | math          |
| 10_17 | PG_lv3\_숫자게임                      | [숫자게임](프로그래머스/3/12987. 숫자 게임/숫자게임.java)                                  | math          |
| 10_17 | PG_lv3\_단속카메라                    | [단속카메라](프로그래머스/3/42884. 단속카메라/단속카메라.java)                             | Greedy        |
| 10_18 | PG_lv3\_기지국설치                    | [기지국설치](프로그래머스/3/12979. 기지국 설치/기지국설치.java)                            | math          |
| 10_21 | PG_lv3\_스티커모으기                  | [스티커모으기](프로그래머스/3/12971. 스티커 모으기（2）/스티커.java)                       | dp            |
| 10_21 | PG_lv3\_불량사용자                    | [불량사용자](프로그래머스/3/64064. 불량 사용자/불량사용자.java)                            | dfs           |
| 10_21 | PG_lv3\_순위                          | [순위](프로그래머스/3/49191. 순위/순위.java)                                               | 플루이드 워셜 |
| 10_21 | PG_lv3\_거스름돈                      | [거스름돈](프로그래머스/3/12907. 거스름돈/거스름돈.java)                                   | dp            |
| 10_21 | PG_lv3\_부대복귀                      | [강철부대](프로그래머스/3/132266. 부대복귀/부대복귀)                                       | dijkstra      |
| 10_28 | BG_S3\_프린터큐                       | [프린터큐](백준/Silver/1966. 프린터 큐/프린터큐.java)                                      | Queue         |

## 2023_11

| 날짜  | 문제                 | 링크                                                                           | 유형        |
| ----- | -------------------- | ------------------------------------------------------------------------------ | ----------- |
| 11_04 | CT\_기울어진직사각형 | [기울어진직사각형](코드트리/Simulation/기울어진직사각형/기울어진직사각형.java) | simulataion |
| 11_04 | CT\_숫자의순차적이동 | [숫자의순차적이동](코드트리/Simulation/숫자의순차적이동/숫자.java)             | simulataion |
| 11_04 | PG_lv2\_다음큰숫자   | [다음큰숫자](프로그래머스/2/12911. 다음 큰 숫자/다음큰숫자.java)               | binary      |
| 11_04 | CT\_영어끝말잇기     | [영어끝말잇기](프로그래머스/2/12981. 영어 끝말잇기/영어끝말잇기.java)          | simulataion |
